...
"@
    ...
    Write-Host ""
    Write-Warn "There is no password on this app, and no accounts. Whoever can reach"
    Write-Warn "it can read every note in it and add, edit or archive notes. Tailnet"
    Write-Warn "membership is the whole of its security, and removing a device in the"
    Write-Warn "Tailscale admin console is the only way to take access away."
    Write-Host ""
